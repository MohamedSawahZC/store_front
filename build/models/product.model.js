...
var ProductModel = /** @class */ (function () {
    ...
    ProductModel.prototype.formatProduct = function (product) {
        return {
            id: product.id,
            name: product.name,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, this.formatProduct(result.rows[0])];
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not create product ".concat(err_1));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows.map(function (p) { return _this.formatProduct(p); })];
                    case 3:
                        err_2 = _a.sent();
    ...
    ProductModel.prototype.edit = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not update product ".concat(p.name, ", ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not delete product ".concat(id, ". ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductModel.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, connection, result, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not find product ".concat(id, ". ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
