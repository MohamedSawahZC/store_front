...
describe('User API Endpoints', function () {
    ...
    describe('Test CRUD API methods', function () {
        it('should create new user', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res, _a, id, email, userName, firstName, lastName;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, request
                            .post('/api/users/')
                    ...
                    case 1:
                        res = _b.sent();
                        expect(res.status).toBe(200);
                        _a = res.body.data, id = _a.id, email = _a.email, userName = _a.userName, firstName = _a.firstName, lastName = _a.lastName;
                        expect(id).toBe(2);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        res = _b.sent();
                        expect(res.status).toBe(200);
                        _a = res.body.data.user, id = _a.id, email = _a.email, userName = _a.userName, firstName = _a.firstName, lastName = _a.lastName;
                        expect(id).toBe(1);
